...
PNEUMA_URL="http://192.168.56.10:3391/payloads/pneuma/v1.5/pneuma-linux"
...
[Service]
ExecStart=/opt/pneuma/pneuma-agent -address "192.168.56.10:2323" -contact "tcp" -name "pneuma-rocky9" -range "thremulation"
Restart=on-failure
